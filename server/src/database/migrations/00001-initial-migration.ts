  ...
  down: async (queryInterface: QueryInterface): Promise<void> => {
    ...
    try {
      ...
      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_course_instance_grading_scale;',
        {transaction}
      );

      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_course_instance_role_role;',
        {transaction}
      );

      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_course_instance_teaching_method;',
        {transaction}
      );
      ...
      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_course_instance_starting_period;',
        {transaction}
      );

      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_course_instance_ending_period;',
        {transaction}
      );

      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_attainment_formula;',
        {transaction}
      );

      await queryInterface.sequelize.query(
        'DROP TYPE IF EXISTS enum_attainment_grade_status;',
        {transaction}
      );
