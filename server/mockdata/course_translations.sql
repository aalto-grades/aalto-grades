...
(1, 'SE', 'Institutionen för datateknik', 'Programmering 1', NOW(), NOW()),
(2, 'EN', 'Department of Computer Science', 'Programming 2', NOW(), NOW()),
(2, 'FI', 'Tietotekniikan laitos', 'Programming 1', NOW(), NOW()),
(2, 'SE', 'Institutionen för datateknik', 'Programming 2', NOW(), NOW()),
...
(3, 'SE', 'Institutionen för teknisk fysik', 'Elektromagnetism (SCI)', NOW(), NOW()),
...
(4, 'SE', 'Institutionen för produktionsekonomi', 'Produktionsekonomi 1', NOW(), NOW()),
(5, 'EN', 'Department of Computer Science', 'Databases', NOW(), NOW()),
(5, 'FI', 'Tietotekniikan laitos', 'Tietokannat', NOW(), NOW()),
(5, 'SE', 'Institutionen för datateknik', 'Databaser', NOW(), NOW()),
...
(6, 'SE', 'Institutionen för matematik och systemanalys', 'Differential- och integralkalkyl 1 (SCI)', NOW(), NOW());