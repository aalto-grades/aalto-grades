...
(1, null, 'test assignment 1.1', 'tag1', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag5", 2], ["tag9", 2], ["tag16", 2], ["tag17", 2], ["tag18", 2]] }'),
(2, null, 'test assignment tree', 'tag2', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag6", 2], ["tag10", 2]] }'),
(3, null, 'test assignment 3.1', 'tag3', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag7", 2], ["tag11", 2]] }'),
(5, null, 'test assignment 4.1', 'tag4', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag8", 2], ["tag12", 2]] }'),
...
(8, null, 'test assignment tree', 'tag13', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag14", 2], ["tag15", 1]] }'),
...
(9, null, 'test assignment model 9', 'tag19', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [] }'),
...
(7, null, 'test assignment tree m:7', 'tag197', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag198", 0.4], ["tag199", 0.6]] }'),
(7, 197, 'test assignment tree m:7', 'tag198', 365, NOW(), NOW(), 'MANUAL', NULL),
(7, 197, 'test assignment tree m:7', 'tag199', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag200", 0.1], ["tag201", 0.1], ["tag202", 0.8]] }'),
...
(7, 199, 'test assignment tree m:7', 'tag202', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag203", 0.5], ["tag204", 0.5]] }'),
...
(4, null, 'test assignment tree m:4', 'tag205', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag206", 0.5], ["tag207", 0.5]] }'),
(4, 205, 'test assignment tree m:4, sub', 'tag206', 365, NOW(), NOW(), 'MANUAL', NULL),
(4, 205, 'test assignment tree m:4, sub', 'tag207', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [] }'),
(6, null, 'test assignment tree m:6', 'tag208', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag209", 0.75], ["tag210", 0.25]] }'),
...
(10, null, 'test assignment tree m:10', 'tag211', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag212", 0.75], ["tag213", 0.25]] }'),
...
(24, null, 'test final grades', 'tag226', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag227", 0.25]] }'),
(24, 226, 'test final grades', 'tag227', 365, NOW(), NOW(), 'MANUAL', NULL),
(25, null, 'calculate correct', 'tag228', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag229", 0.75], ["tag230", 0.25]] }'),
(25, 228, 'calculate correct', 'tag229', 365, NOW(), NOW(), 'MANUAL', NULL),
(25, 228, 'calculate correct', 'tag230', 365, NOW(), NOW(), 'MANUAL', NULL),
(26, null, 'calculate multiple', 'tag231', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag232", 0.75], ["tag233", 0.25]] }'),
(26, 231, 'calculate multiple', 'tag232', 365, NOW(), NOW(), 'MANUAL', NULL),
(26, 231, 'calculate multiple', 'tag233', 365, NOW(), NOW(), 'MANUAL', NULL),
(27, null, 'calculate depth', 'tag234', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag235", 0.4], ["tag236", 0.6]] }'),
(27, 234, 'calculate depth', 'tag235', 365, NOW(), NOW(), 'MANUAL', NULL),
(27, 234, 'calculate depth', 'tag236', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag237", 0.1], ["tag238", 0.1], ["tag239", 0.8]] }'),
(27, 236, 'calculate depth', 'tag237', 365, NOW(), NOW(), 'MANUAL', NULL),
(27, 236, 'calculate depth', 'tag238', 365, NOW(), NOW(), 'MANUAL', NULL),
(27, 236, 'calculate depth', 'tag239', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag240", 0.5], ["tag241", 0.5]] }'),
(27, 239, 'calculate depth', 'tag240', 365, NOW(), NOW(), 'MANUAL', NULL),
(27, 239, 'calculate depth', 'tag241', 365, NOW(), NOW(), 'MANUAL', NULL),
(28, null, 'calculate override', 'tag242', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["tag243", 0.5], ["tag244", 0.5]] }'),
(28, 242, 'calculate override', 'tag243', 365, NOW(), NOW(), 'MANUAL', NULL),
(28, 242, 'calculate override', 'tag244', 365, NOW(), NOW(), 'MANUAL', NULL),
(29, null, 'Grade', 'grade', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["exercise", 0.4], ["project", 0.2], ["exam", 0.4]] }'),
...
(30, null, 'Grade', 'grade', 365, NOW(), NOW(), 'WEIGHTED_AVERAGE', '{ "weights": [["project", 0.6], ["exam", 0.4]] }'),
