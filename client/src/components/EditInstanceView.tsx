...
export default function EditInstanceView(): JSX.Element {
  ...
  const {courseId, sisuInstanceId}: Params = useParams() as {
    courseId: string;
  ...
  if (sisuInstanceId) sisuInstance = useGetSisuInstance(sisuInstanceId);
      ...
      {course.data && (sisuInstance === null || !sisuInstance.isLoading) ? (
        <>
          ...
          {sisuInstanceId && (
            <Typography
              variant="body2"
              sx={{flexGrow: 1, mb: 2, textAlign: 'left'}}
            >
            ...
            initialValues={
              sisuInstance !== null && sisuInstance.data
                ? {
                    ...
                    startingPeriod:
                      sisuInstance.data.startingPeriod ?? Period.I,
              ...
              <Form>
                ...
                >
                  ...
                  <TextField
                    ...
                    error={
                      touched.startingPeriod && Boolean(errors.startingPeriod)
                    }
                    onChange={handleChange}
                    select
                  >
