    ...
    <Box sx={{ mr: -4, ml: -4 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-evenly', gap: 3 }}>
        ...
        { /* a different assignment component will be created for students */
          (auth.role == 'SYSADMIN' || auth.role == 'TEACHER') && 
          <Assignments assignments={mockSuggestedAssignments} formula={'Weighted Average'} instance={mockCurrentInstance} courseCode={courseCode}/> /* TODO: Retrieve real formula */
        }
      </Box>
